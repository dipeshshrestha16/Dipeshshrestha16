...
<img src="https://readme-typing-svg.demolab.com?font=Share+Tech+Mono&size=18&duration=2500&pause=1200&color=9b59b6&width=560&height=30&lines=AI+%2F+ML+Engineer+%7C+Full+Stack+Developer;Python+%7C+PHP+%7C+Java;AI+%26+ML+Enthusiast;Currently+Working+On%3A+Bigroos+Tech+Website" alt="Title"/>
</td>
</tr>
</table>
<br/><br/>
...
<img src="https://skillicons.dev/icons?i=python,php,java,js&theme=dark&perline=4"/>

**Frameworks & Platforms**

<img src="https://skillicons.dev/icons?i=flask,django,aws,wordpress,docker,postman&theme=dark&perline=6"/>
...
| # | Project | Type | Link |
|:-:|:--------|:----:|:----:|
| `01` | **URL Shortener**   | `API` `Flask` `JS`| [→](https://github.com/dipeshshrestha16/URL-Shortener-API) |
